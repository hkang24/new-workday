...
export default function Page() {
    ...
    async function onFormSubmit(event) {
        ...
        const res = await axios.post(`/api/signupApplicant`, formData);
        ...
        <div className="flex min-h-screen flex-1 flex-col justify-center items-center px-6 py-12 lg:px-8">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
                    Register an <span className="text-blue">Applicant</span> account
                </h2>
            </div>
            <div>
                <p className="mt-2 text-center text-sm leading-6 text-gray-500">
                    Already have an account?{' '}
                    <a href="/signin/applicant" className="font-semibold leading-6 text-orange hover:text-yellow">
                        Sign in now!
                    </a>
                </p>
            </div>
