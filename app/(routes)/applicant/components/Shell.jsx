            ...
            <div>
                                    ...
                                    >
                                        <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                                            <button type="button" className="-m-2.5 p-2.5" onClick={() => setSidebarOpen(false)}>
                                                ...
                                                <XMarkIcon className="h-6 w-6 text-dark-blue" aria-hidden="true" />
                                            </button>
                                        </div>
                                    </Transition.Child>
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-48 lg:flex-col">
                    ...
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
                        <div className="flex h-20 shrink-0 items-center mt-5">
                            <Image src={"/images/logo.png"} alt="logo" width={300} height={300} />
                        </div>
                        <nav className="flex flex-1 flex-col mt-10">
                            <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                        ...
                                        {navigation.map((item) => (
                                            <li key={item.name}>
                                                ...
                                                >
                                                    <item.icon
                                                        className={classNames(
                                                            current === item.name ? 'text-blue' : 'text-gray-4000 group-hover:text-blue',
                                                            'h-6 w-6 shrink-0'
                                                        )}
                                                        aria-hidden="true"
                                                    />
                                ...
                                <li className="mt-auto flex w-full justify-center mb-5">
                ...
                <main className="lg:pl-48 h-full min-h-screen">
                    <div className="h-full min-h-screen bg-beige" >{children}</div>
                </main>
