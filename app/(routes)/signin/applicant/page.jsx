    ...
    return (
            ...
            <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    <img
                        ...
                        src="https://www.dropbox.com/scl/fi/e2n0wx3uu2v3bicus09td/easyapplylogo.svg?rlkey=n0ecagfqq35j8lg8qpmww5p30&st=awcjoqag&dl=0&raw=1"
                        alt="Your Company"
                    />
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
                        Sign in to your <span className="text-blue">Applicant</span> account
                    </h2>
                </div>
                <div>
                    <p className="mt-2 text-center text-sm leading-6 text-gray-500">
                        Don't have an account?{' '}
                        <a href="/signup/applicant" className="font-semibold leading-6 text-orange hover:text-yellow">
                            Create one now!
                        </a>
                    </p>
                </div>
