...
export async function POST(request) {
    try {
      ...
      const { email, password, company, firstName, lastName } = Object.fromEntries(formData);
      ...
      await supabase.from('users').insert([{ id, email, first_name: firstName, last_name: lastName, company, applicant: false }]);
